...
object TalkRpnGlyphs {
    ...
    private val GLYPHS: Map<Char, Long> = mapOf(
        ...
        // ---- Digits ---------------------------------------------------------
        //
        // FULL WIDTH, every one - the 1 included: its stems are the RIGHT
        // column (B/C), as on real seven-segment hardware, and the layout
        // decrees it a whole cell regardless (TalkRpnFont's DIGIT_ONE_MASK),
        // so digit strings keep one rhythm and equal digit counts set to
        // equal lengths. Right vertical is B/C, bars run the whole cell -
        // that full width is what gives the digits their proportions.
        //
